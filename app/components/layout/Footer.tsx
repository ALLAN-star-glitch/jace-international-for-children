...
const IconMap = {
  ...
  location: (props: any) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
  ),
  phone: (props: any) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
  ),
  email: (props: any) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
  ),
};
  ...
  return (
    <footer className="relative text-white">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        {/* Black gradient */}
        <div className="absolute inset-0 bg-gradient-to-t from-deep-blue/35 via-deep-blue/20 to-deep-blue/10" />
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-10">
            ...
            <div className="md:col-span-2">
              {NAVIGATION_ITEMS.map((item) => (
                <Link key={item.href} href={item.href} className="block text-white/70 hover:text-white">
                  {item.label}
                </Link>
              ))}
            </div>
            ...
            <div className="md:col-span-3">
              <form onSubmit={handleSubmit} className="space-y-3">
                <input
                  ...
                  placeholder="Email"
                  className="w-full bg-transparent border-b border-white/30 py-2"
                />
                <button type="submit" className="text-sm text-white/80">
                  Subscribe
                </button>
                {isSubscribed && <p className="text-green-400 text-sm">Subscribed!</p>}
              </form>
            </div>

          </div>

          <div className="text-center text-white/50 text-xs mt-2 mb-0">
            © {currentYear} JACE International for Children
          </div>
        </Container>
      </div>
    </footer>
